            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-2xl border border-slate-200 dark:border-slate-700"
                        ...
                        <div className="p-6">
                            <div className="relative mb-4">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border border-slate-300 dark:border-slate-600 rounded-md bg-white dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                />
                            </div>
                                ...
                                {loadingSearch ? <div className="flex justify-center p-4"><Spinner /></div> : (
                                    <ul className="space-y-2">
                                        {searchResults.map(user => (
                                            <li key={user._id} className="flex items-center justify-between p-2 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800">
                                                <div>
