  ...
  return (
    <>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex-1 min-h-[500px] h-full flex flex-col rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-white dark:bg-slate-950 shadow-sm">
          {activeWorkflow ? (
