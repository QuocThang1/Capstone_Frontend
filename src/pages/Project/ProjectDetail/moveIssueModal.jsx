...
const MoveIssuesModal = ({ isOpen, onClose, columnToDelete, otherColumns, onConfirm }) => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex justify-center items-center p-4 bg-black/60" onClick={onClose}>
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-lg border-2 border-slate-300 dark:border-slate-700" onClick={e => e.stopPropagation()}>
